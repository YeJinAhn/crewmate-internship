...
4.개인정보 수집 및 이용 동의
5.마케팅 개인정보 활용 동의 
6.“전체 약관에 동의합니다” 체크 시 상단에 있는 모든 체크박스 체크 처리됨. 
7.전체 체크 후 각 개별 체크박스 수정 가능
8.[취소] 버튼을 누르면 메인화면으로 이동한다. 
9.[다음] 버튼을 누르면 “2. 본인인증” 화면으로 넘어간다.  
10.각 필수 동의 항목에 체크를 하지 않고 [다음] 버튼 클릭 시 각 항목별 체크에 대한 Alert 창 나타남 
